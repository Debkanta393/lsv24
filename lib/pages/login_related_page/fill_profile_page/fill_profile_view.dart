                ...
                callback: () async {
                  ...
                  try {
                    ...
                    if (AdminSettingsApi.adminSettingsModel?.setting != null &&
                      ...
                      print(
                          "  - adminSettings: ${AdminSettingsApi.adminSettingsModel?.setting != null}");
                      print("  - loginUserId: ${Database.loginUserId != null}");
                      print(
                          "  - profileModel: ${GetProfileApi.profileModel?.user != null}");
                      CustomToast.show(
