                ...
                callback: () async {
                  ...
                  try {
                    ...
                    if (_signUpModel?.user?.ipAddress == null ||
                      ...
                      print("📝 Profile incomplete - going to fill profile");
                    ...
                    // Step 4: Profile is complete - load data and navigate
                    print("✅ Profile complete - loading data...");
                    ...
                    // ✅ ALWAYS load fresh admin settings
                    print("⏳ Loading admin settings...");
                    final settingsSuccess = await AdminSettingsApi.callApi();
                    print("📥 Settings loaded: $settingsSuccess");
                    ...
                    print("📊 Data check:");
                    print("  - Settings: $hasSettings");
                    print("  - UserId: $hasUserId");
                    print("  - Profile: $hasProfile");

                    if (hasSettings && hasUserId && hasProfile) {
                      print("🏠 All data loaded - navigating home...");
                      Get.offAll(() => const MainHomePageView());
                    } else {
                      print("❌ Missing data:");
                      if (!hasSettings) {
                        print("  - Settings API returned: $settingsSuccess");
                        print(
                            "  - Model: ${AdminSettingsApi.adminSettingsModel}");
                        CustomToast.show(
                      ...
                      children: [
                            ...
                            if (response != null &&
                              ...
                              if (_signUpModel != null &&
                                ...
                                if (_signUpModel?.message ==
                                  ...
                                  CustomToast.show(
                                      AppStrings.googleLoginFailed.tr);
                                }
                              }
                            } else {
                              Get.back();
                        ...
                        CustomBoxButton(
                          callback: Platform.isIOS
                                  ...
                                  try {
                                    ...
                                    if (_signUpModel != null &&
                                      ...
                                      if (_signUpModel?.status == true &&
                                        ...
                                        if (Database.isNewUser == false &&
                                            AdminSettingsApi.adminSettingsModel
                                                    ?.setting !=
                                                null &&
                                            Database.loginUserId != null &&
                                            GetProfileApi.profileModel?.user !=
                                    ...
                                    if (e
                                      ...
                                      switch (e.code) {
                                        ...
                                        case AuthorizationErrorCode.notHandled:
                                          CustomToast.show(
                                              "Apple Sign In not available. Please try again.");
                                          break;
                              ...
                              : () {
                                  CustomToast.show(
                                      AppStrings.thisIsNotIosPlatform.tr);
                                },
