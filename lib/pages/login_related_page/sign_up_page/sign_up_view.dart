            ...
            children: [
              ...
              BasicButton(
                ...
                callback: () async {
                  ...
                  AppSettings.showLog("📊 Signup check result:");
                  AppSettings.showLog("  - status: ${_loginModel?.status}");
                  AppSettings.showLog("  - isLogin: ${_loginModel?.isLogin}");
                  AppSettings.showLog("  - message: ${_loginModel?.message}");
                  ...
                  if (_loginModel?.status == true &&
                    ...
                    SignUpSendOtpApi.callApi(emailController.text.trim());
