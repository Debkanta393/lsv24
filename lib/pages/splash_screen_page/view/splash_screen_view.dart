...
import 'package:metube/pages/on_boarding_page/on_boarding_view.dart';
  ...
  void splashScreen() async {
    ...
    try {
      ...
      if (Database.loginUserId != null && Database.loginUserId!.isNotEmpty) {
        ...
        AppSettings.showLog("  - Profile exists: ${GetProfileApi.profileModel?.user != null}");
        AppSettings.showLog("  - Is blocked: ${GetProfileApi.profileModel?.user?.isBlock}");
    ...
    AlertDialog(
      ...
      actions: [
        ...
        TextButton(
          onPressed: () {
            Get.back();
            Get.offAll(() => const MainHomePageView()); // ← changed from LoginView
          },
