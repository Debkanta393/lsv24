    ...
    try {
      ...
      if (videoDetailsModel != null) {
        ...
        customChanges["subscribe"] =
            videoDetailsModel!.detailsOfVideo!.totalSubscribers!;
...
// ✅ Static helper for images too
  ...
  void _showMidrollAd() async {
    ...
    AppSettings.showLog(
        "Showing mid-roll ad ${adShowCount + 1}/${adTimings.length}");
  ...
  void onAdFailed() {
    AppSettings.showLog("Ad failed, resuming video");
    showAd = false;
    isAdLoading = false;
    adShowCount--;
  ...
  void createWatchHistory() async {
    if (AppSettings.isCreateHistory.value) {
      ...
      for (int index = 0;
          ...
          index++) {
        if (WatchHistory.mainWatchHistory[index]["videoId"] ==
