...
import 'package:metube/pages/preview_channel_page/preview_shorts_channel_view.dart';
...
class _ShortsVideoDetailsViewState extends State<ShortsVideoDetailsView> {
    ...
    try {
      ...
      if (videoDetailsModel != null) {
        ...
        customChanges["comment"] =
            videoDetailsModel!.detailsOfVideo!.totalComments!;
  ...
  void onClickLike() async {
    if (!isLike.value) {
      ...
      await LikeDisLikeVideoApi.callApi(
          videoDetailsModel!.detailsOfVideo!.id.toString(), true);
    }
  }
  ...
  void onClickDisLike() async {
    if (!isDisLike.value) {
      ...
      customChanges["disLike"]++;
      await LikeDisLikeVideoApi.callApi(
          videoDetailsModel!.detailsOfVideo!.id.toString(), false);
    }
  }
  ...
  void onClickShare() async {
    ...
    await ShareCountApiClass.callApi(Database.loginUserId!,
        videoDetailsModel!.detailsOfVideo!.id.toString());
  ...
  void onClickSubscribe() async {
    if (isPrivateContent.value && isSubscribe.value == false) {
      ...
      await SubscribeChannelApiClass.callApi(
          videoDetailsModel!.detailsOfVideo!.channelId.toString());
    }
  }
