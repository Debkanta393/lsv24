...
import 'package:google_fonts/google_fonts.dart';
import 'package:metube/ads/google_ads/google_large_native_ad.dart';
import 'package:metube/ads/google_ads/google_video_ad.dart';
import 'package:metube/custom/custom_api/like_dislike_api.dart';
import 'package:metube/custom/custom_method/custom_download.dart';
import 'package:metube/custom/custom_method/custom_format_number.dart';
import 'package:metube/custom/custom_method/custom_format_timer.dart';
                                            ...
                                            itemBuilder: (context, index) {
                                              ...
                                              return ((indexData.videoPrivacyType ==
                                                  ...
                                                  ? PrivateContentNormalVideoUi(
                                                      ...
                                                      title:
                                                          indexData.title ?? "",
                                                      videoImage: ConvertToNetwork.resolve(indexData.videoImage ?? ''),
                                                      videoUrl:
                                                          indexData.videoUrl ??
                                                              "",
                                                      videoTime:
                                                      ...
                                                      channelId:
                                                          indexData.channelId ??
                                                              "",
                                                      channelImage: ConvertToNetwork.resolve(indexData.user?.image ?? ''),
                                                      channelName: indexData
                                                              .user?.fullName ??
                                                          "",
                                                      views: indexData
                                                          ...
                                                          NormalVideoUi(
                                                            ...
                                                            title: controller
                                                                .mainRelatedVideos![
                                                                    index]
                                                                .title!,
                                                            videoImage: ConvertToNetwork.resolve(controller.mainRelatedVideos![index].videoImage!),
                                                            videoUrl: controller
                                                                .mainRelatedVideos![
                                                                    index]
                                                                .videoUrl!,
                                                            ...
                                                            channelId: controller
                                                                .mainRelatedVideos![
                                                                    index]
                                                                .channelId!,
                                                            channelImage: ConvertToNetwork.resolve(controller.mainRelatedVideos![index].user!.image!),
                                                            channelName: controller
                                                                .mainRelatedVideos![
                                                                    index]
                                                                .user!
